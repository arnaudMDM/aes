...
if __name__ == "__main__":
    assert convertTabInStrHex(aes_encrypt(convertStrInTab("3243f6a8885a308d313198a2e0370734"), convertStrInTab("2b7e151628aed2a6abf7158809cf4f3c"))) == "3925841d02dc09fbdc118597196a0b32"
    print "OK"
